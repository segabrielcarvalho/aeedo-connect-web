...
import beneficiosTransplant from '@/images/beneficiosTransplant.jpg'
import imageDoacaoOrgaos from '@/images/DoacaoOrgaos.jpg'
...
function Discover() {
  return (
    <Section title="Importância da Doação de Órgãos" image={{ src: imageDoacaoOrgaos }}>
...
function Build() {
  return (
    <Section title="Requisitos e Procedimentos" image={{ src: imageOrgao, shape: 1 }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
...
function Deliver() {
  return (
    <Section title="Benefícios e Riscos" image={{ src: beneficiosTransplant, shape: 2 }}>
      <div className="space-y-6 text-base text-neutral-600">
        <p>
